...
---------------------------------------------------------------------------------------------
  Имеет ли регистр значение в JavaScript?
  
Да

---------------------------------------------------------------------------------------------
  Какое событие происходит, когда пользователь нажимает на HTML элемент?
  
onclick

---------------------------------------------------------------------------------------------
  Как найти наибольшее число среди x & y?
  
Math.max(x, y)

---------------------------------------------------------------------------------------------
  Как правильно изменить HTML в <p id="text">some text</p>

document.getElementById('text').innerHTML = 'new text'

---------------------------------------------------------------------------------------------
  Как получить элемент с id="app"?
...
---------------------------------------------------------------------------------------------
  Как мы можем получить свойство name у объекта user?
...
---------------------------------------------------------------------------------------------
  Какие есть ключевые слова для создания переменных в JavaScript? *
...
Function Declaration можно вызывать до определения, Function Expression - нет
...
Если вы используете isNaN(), вам придется выполнить дополнительные проверки
...
---------------------------------------------------------------------------------------------
  Сколько типов данных есть в JavaScript? *
